<?php
session_start();
require '../api/db.php'; // Inclui a conexão com a base de dados
    ...
    if (isset($_SESSION['role_id']) && $_SESSION['role_id'] === 1)
            {
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="areaadmin2.php">Administração da Loja</a>
                        <div class="ms-auto">
...
<script>
    function deleteProduct(id)
    {
        ...
        {
            window.location.href = "../api/eliminar_produto.php?id=" + id;
        }
    }
