<?php
require '../api/auth.php'; // Inclui o sistema de autenticação
...
require '../api/db.php'; // Conexão com a base de dados
        ...
        <tbody>
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <form action="../api/auth.php" method="post" class="d-flex align-items-center justify-content-center gap-2">
...
<script src=<?php echo "https://www.paypal.com/sdk/js?client-id=ChavePayPal&currency=EUR" ?>></script>
<script>
    paypal.Buttons(
    {
